...
<head>
  ...
  <title>Playonlineds- Add Money</title>
...
<body>
  <div class="container text-center">
    ...
    <div class="qr-section">
      ...
      <div class="qr-image">
        <img src="{{ URL::asset('/backend/uploads/Payment_qrcode/' . rawurlencode($qr_code->image)) }}?v={{ optional($qr_code->updated_at)->timestamp ?? time() }}" alt="QR Code">
        <h4 class="mt-2">Amount : <?php echo $amount; ?> </h4>
      </div>

      <div class="helpline mt-4">
        Helpline Number - <span class="helpline-number">+91 {{ optional($upi)->help_line_number }}</span>
      </div>
  ...
  <div class="container">
    <div class="row text-center">
      ...
      <div class="col-md-12">
        ...
        <div class="image_qr">
          <img src="{{ URL::asset('/backend/uploads/Payment_qrcode/' . rawurlencode($qr_code->image)) }}?v={{ optional($qr_code->updated_at)->timestamp ?? time() }}">
        </div>
